...
export default function SummaryPage() {
  ...
  return (
    <div className="h-screen md:h-[90vh] flex flex-col overflow-hidden text-black bg-white">
      <main className="flex-1 w-full bg-white overflow-hidden">
        <div className="md:h-full max-w-full mx-5 px-4 md:px-auto flex flex-col h-full">
          ...
          <div className="grid md:grid-cols-[1.5fr_8.5fr_3.15fr] gap-4 mt-10 pb-40 md:gap-4 md:pb-0 flex-1">
            ...
            <div className="relative bg-gray-100 p-4 flex flex-col items-center justify-center md:h-[57vh] md:border-t">
              ...
              <p className="md:absolute text-xs md:text-sm lg:text-base font-normal mb-1 leading-[24px] md:bottom-[-15%] md:left-[22%] lg:left-[30%] xl:left-[40%] 2xl:left-[45%] text-black">
          ...
          <div className="pt-4 md:pt-[37px] pb-6 bg-white mt-auto">
            <div className="flex justify-between max-w-full mx-auto px-4 md:px-0">
              ...
              >
                <div className="relative w-12 h-12 flex items-center justify-center border border-[#1A1B1C] rotate-45 scale-[1] sm:hidden transition-transform duration-200 group-hover:scale-105">
              ...
              <button
                ...
                className="group flex flex-row relative justify-center items-center cursor-pointer"
              >
                <div className="w-12 h-12 flex items-center justify-center border border-[#1A1B1C] rotate-45 scale-[1] sm:hidden transition-transform duration-200 group-hover:scale-105">
                  <span className="rotate-[-45deg] text-xs font-semibold sm:hidden">
                    HOME
                  </span>
                </div>
